					...
					array(
					   ...
					   "params" => array(
							...
							array(
								...
								"param_name"	=>	"content_title_format",
								"value"			=>	array(
							...
							array(
								"type"			=>	"dropdown",
								"class"			=>	"",
								"heading"		=>	__("Description HTML Format", "hgrextender"),
								"param_name"	=>	"content_description_format",
								"value"			=>	array(
									__( 'H1', 'hgrextender' ) => 'h1',
									__( 'H2', 'hgrextender' ) => 'h2',
									__( 'H3', 'hgrextender' ) => 'h3',
					...
					$output .= '<div class="hgr-content-block-tb '.$contb_extra_class.' ' . esc_attr( $css_class ) . '" style="margin-bottom:2em;text-align:center;">';
						...
						$output .= '<div class="hgr-content-tb">';
							if(!empty($content_title)) {
								$output .='<'.$content_title_format.' style="color:'.$content_title_color.'">'.$content_title.'</'.$content_title_format.'>';
							}
							
							if(!empty($content_description)) {
								$output .='<'.$content_description_format.' style="color:'.$content_desc_color.'">'.$content_description.'</'.$content_description_format.'>';
							}
