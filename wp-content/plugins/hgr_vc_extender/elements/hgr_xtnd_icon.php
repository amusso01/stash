...
if(!class_exists('HGR_VC_ICON')) {
	...
	*/
	...
	if($content_icon !== '' && $icon_background_type == 'none') {
		...
		$output .= '<div class="hgr-icontxt nobg ' . esc_attr( $css_class ) . ' '.$icon_id.' '.$icntxt_extraclass.'" style="'.$alignment_style.'">';
	...
	if($content_icon !== '' && $icon_background_type == 'icon-background-select') {
