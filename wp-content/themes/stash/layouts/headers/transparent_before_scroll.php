...
<div id="hgr_top_navbar_container" class="hgr_transparent_before_scroll hgr_navbar <?php echo ( !is_front_page() ? '' : ( $hgr_options['header_floating'] == 2 ? 'hidden' : '') ); ?>">
    ...
    <div class="hgr_identity">
    	<a href="<?php echo esc_url( home_url( '/' ) );?>" title="<?php echo get_bloginfo('name');?>">
			...
			?>
			<img src="<?php echo esc_url( get_template_directory_uri() );?>/highgrade/images/logo@2x.png" alt="<?php echo get_bloginfo('name');?>" class="logo" />
			<?php
				endif;
			?>
    	</a>
