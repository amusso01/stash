...
<?php if ( ! function_exists( 'has_site_icon' ) || ! has_site_icon() && !empty($hgr_options['favicon']['url']) ) : ?>
<link href="<?php echo esc_url($hgr_options['favicon']['url']);?>" rel="icon">
<link href="<?php echo esc_url($hgr_options['favicon']['url']);?>" rel="apple-touch-icon">
<link href="<?php echo esc_url($hgr_options['favicon']['url']);?>" rel="apple-touch-icon" sizes="76x76" />
<link href="<?php echo esc_url($hgr_options['favicon']['url']);?>" rel="apple-touch-icon" sizes="120x120" />
<link href="<?php echo esc_url($hgr_options['favicon']['url']);?>" rel="apple-touch-icon" sizes="152x152" />
<?php else : ?>
<link href="<?php echo esc_url(get_template_directory_uri().'/highgrade/images/favicon.png');?>" rel="icon">
<link href="<?php echo esc_url(get_template_directory_uri().'/highgrade/images/favicon.png');?>" rel="apple-touch-icon">
<link href="<?php echo esc_url(get_template_directory_uri().'/highgrade/images/favicon.png');?>" rel="apple-touch-icon" sizes="76x76" />
<link href="<?php echo esc_url(get_template_directory_uri().'/highgrade/images/favicon.png');?>" rel="apple-touch-icon" sizes="120x120" />
<link href="<?php echo esc_url(get_template_directory_uri().'/highgrade/images/favicon.png');?>" rel="apple-touch-icon" sizes="152x152" />
<?php endif; ?>
