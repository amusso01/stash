<?php
/**
 * Stash Theme: Blog page, single post display
 * @package WordPress
...
<div id="<?php echo esc_html($post->post_name);?>" class="row standAlonePage <?php echo ( !empty($hgr_page_color_scheme) ? esc_attr($hgr_page_color_scheme) : ' light-scheme ');?>" style=" <?php echo esc_attr($backgroundColor);?> <?php echo ( isset($page_offset) && $page_offset	!= 0 ? ' margin-top:'.$page_offset	.';' : '');?>">
