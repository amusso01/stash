 ...
 * Stash Theme:		Page with left sidebar
 * @package:		WordPress
 ...
 */
 ...
 <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
 <div id="<?php echo esc_html($post->post_name);?>" class="row standAlonePage <?php echo ( !empty($hgr_page_color_scheme) ? esc_attr($hgr_page_color_scheme) : ' light-scheme ');?>" style=" <?php echo esc_attr($backgroundColor);?> ">
  ...
  <?php endif;?>
    ...
    <div class="container" style=" <?php echo ( !empty($hgr_page_top_padding) ? ' padding-top:'.esc_attr($hgr_page_top_padding).'px!important;' : '' ); echo ( !empty($hgr_page_btm_padding) ? ' padding-bottom:'.esc_attr($hgr_page_btm_padding).'px!important;' : '' );?> ">
      <div class="slideContent vc_col-md-9 vc_col-sm-12 vc_col-xs-12 rightFloated">
